...
class landmark:
  """landmark objects.  Have a dictionary of months"""
...
def get_weather (location, month):
  ...
  if low > high:
    #for most months, the lowest high temp is lower than the highest low temp.   since _values uses these as bounds, it can theoretically output a low temp thats higher than the high temp!
    high = low + 20
  return low, high
